...
Proposes real-world questions that require a set of fundamental abilities such as reasoning,
multi-modality handling, web browsing, and generally tool-use proficiency. GAIA questions are
...
| | |
|---|---|
| Upstream | [`src/inspect_evals/gaia`](https://github.com/UKGovernmentBEIS/inspect_evals/tree/main/src/inspect_evals/gaia) |
| Group | Assistants |
| Total samples | 330 |
...
- `huggingface` — `gaia-benchmark/GAIA` (pinned)
